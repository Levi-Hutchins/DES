...
Course: COMP3260
Desc: This file is the implementation of the DES3 variation. DES3 the permnutaiton is missing from the F fucntion
*/
#include "DES3.h"
#include "SBoxes.h"
 ...
 * @desc: 
 */
string DES3::permutate_plaintext(string plaintext){
 ...
 */
string DES3::final_permutation(const string& data) {
 ...
 */
void DES3::left_shift(int count){
    if (!this->is_prime_key) {
        for (int k = 0; k < 2; k++) {
 ...
 */
string DES3::applyPC2(const string& combined) {
 ...
 */
string DES3::xor_strings(const string& a, const string& b) {
 ...
 */
string DES3::feistel_function(const string& right, const string& roundKey) {
    ...
    string output = sBox_substitution(result);
 ...
 */
string DES3::sBox_substitution(const string &input) {
    string output;   
    int s_box_value = 0;
...
void DES3::count_bit_changes(const string& pt, const string& pt_prime) {
 ...
 */
string DES3::encrypt(const string& pt, const string& pt_prime, const string& key) {
...
vector<string> DES3::encrypt_with_two_keys(const string& pt, const string& key, const string& key_prime) {
 ...
 */
string DES3::decrypt(const string& ciphertext, const string& key) {
...
vector<int> DES3::get_bit_difference(){
